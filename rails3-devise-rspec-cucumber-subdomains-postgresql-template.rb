...
@recipes = ["haml", "rspec", "cucumber", "guard", "postgresql", "action_mailer", "devise", "add_user", "home_page", "home_page_users", "seed_database", "users_page", "subdomains", "html5", "navigation", "cleanup", "extras", "git"]
...
if config['rspec']
  after_bundler do
    ...
    run 'bundle exec rake db:create' if recipes.include? 'postgresql'
...
# >-----------------------------[ Postgresql ]------------------------------<
@current_recipe = "postgresql"
@before_configs["postgresql"].call if @before_configs["postgresql"]
say_recipe 'Postgresql'

config = {}
config['postgresql'] = yes_wizard?("Would you like to use postgresql database?") if true && true unless config.key?('postgresql')
@configs[@current_recipe] = config
